...
simHcalTriggerPrimitiveDigis = cms.EDProducer("HcalTrigPrimDigiProducer",
    ...
    weightsHB  = cms.vdouble(1.0, 1.0), ##hardware algo        
    weightsHE1 = cms.vdouble(1.0, 1.0), ##hardware algo        
    weightsHE2 = cms.vdouble(1.0, 1.0), ##hardware algo        
    latency = cms.int32(1),
